...
tape("day.floor(date) returns days", function(test) {
  test.deepEqual(time.day.floor(date.local(2010, 11, 31, 23)), date.local(2010, 11, 31));
  test.deepEqual(time.day.floor(date.local(2011, 00, 01, 00)), date.local(2011, 00, 01));
  test.deepEqual(time.day.floor(date.local(2011, 00, 01, 01)), date.local(2011, 00, 01));
  test.end();
});

tape("day.floor(date) observes daylight saving", function(test) {
  test.deepEqual(time.day.floor(date.utc(2011, 02, 13, 07)), date.local(2011, 02, 12));
  test.deepEqual(time.day.floor(date.utc(2011, 02, 13, 08)), date.local(2011, 02, 13));
  test.deepEqual(time.day.floor(date.utc(2011, 02, 13, 09)), date.local(2011, 02, 13));
  test.deepEqual(time.day.floor(date.utc(2011, 02, 13, 10)), date.local(2011, 02, 13));
  test.deepEqual(time.day.floor(date.utc(2011, 10, 06, 07)), date.local(2011, 10, 06));
  test.deepEqual(time.day.floor(date.utc(2011, 10, 06, 08)), date.local(2011, 10, 06));
  test.deepEqual(time.day.floor(date.utc(2011, 10, 06, 09)), date.local(2011, 10, 06));
  test.deepEqual(time.day.floor(date.utc(2011, 10, 06, 10)), date.local(2011, 10, 06));
  test.end();
});

tape("day.floor(date) handles years in the first century", function(test) {
  test.deepEqual(time.day.floor(date.local(0011, 10, 06, 07)), date.local(0011, 10, 06));
  test.end();
});

tape("day.round(date) returns days", function(test) {
  test.deepEqual(time.day.round(date.local(2010, 11, 30, 13)), date.local(2010, 11, 31));
  test.deepEqual(time.day.round(date.local(2010, 11, 30, 11)), date.local(2010, 11, 30));
  test.end();
});

tape("day.round(date) observes daylight saving", function(test) {
  test.deepEqual(time.day.round(date.utc(2011, 02, 13, 07)), date.local(2011, 02, 13));
  test.deepEqual(time.day.round(date.utc(2011, 02, 13, 08)), date.local(2011, 02, 13));
  test.deepEqual(time.day.round(date.utc(2011, 02, 13, 09)), date.local(2011, 02, 13));
  test.deepEqual(time.day.round(date.utc(2011, 02, 13, 20)), date.local(2011, 02, 14));
  test.deepEqual(time.day.round(date.utc(2011, 10, 06, 07)), date.local(2011, 10, 06));
  test.deepEqual(time.day.round(date.utc(2011, 10, 06, 08)), date.local(2011, 10, 06));
  test.deepEqual(time.day.round(date.utc(2011, 10, 06, 09)), date.local(2011, 10, 06));
  test.deepEqual(time.day.round(date.utc(2011, 10, 06, 20)), date.local(2011, 10, 07));
  test.end();
});

tape("day.round(date) handles midnight in leap years", function(test) {
  test.deepEqual(time.day.round(date.utc(2012, 02, 01, 00)), date.local(2012, 02, 01));
  test.deepEqual(time.day.round(date.utc(2012, 02, 01, 00)), date.local(2012, 02, 01));
  test.end();
});

tape("day.ceil(date) returns days", function(test) {
  test.deepEqual(time.day.ceil(date.local(2010, 11, 30, 23)), date.local(2010, 11, 31));
  test.deepEqual(time.day.ceil(date.local(2010, 11, 31, 00)), date.local(2010, 11, 31));
  test.deepEqual(time.day.ceil(date.local(2010, 11, 31, 01)), date.local(2011, 00, 01));
  test.end();
});

tape("day.ceil(date) observes start of daylight saving", function(test) {
  test.deepEqual(time.day.ceil(date.utc(2011, 02, 13, 07)), date.local(2011, 02, 13));
  test.deepEqual(time.day.ceil(date.utc(2011, 02, 13, 08)), date.local(2011, 02, 13));
  test.deepEqual(time.day.ceil(date.utc(2011, 02, 13, 09)), date.local(2011, 02, 14));
  test.deepEqual(time.day.ceil(date.utc(2011, 02, 13, 10)), date.local(2011, 02, 14));
  test.end();
});

tape("day.ceil(date) observes end of daylight saving", function(test) {
  test.deepEqual(time.day.ceil(date.utc(2011, 10, 06, 07)), date.local(2011, 10, 06));
  test.deepEqual(time.day.ceil(date.utc(2011, 10, 06, 08)), date.local(2011, 10, 07));
  test.deepEqual(time.day.ceil(date.utc(2011, 10, 06, 09)), date.local(2011, 10, 07));
  test.deepEqual(time.day.ceil(date.utc(2011, 10, 06, 10)), date.local(2011, 10, 07));
  test.end();
});

tape("day.ceil(date) handles midnight for leap years", function(test) {
  test.deepEqual(time.day.ceil(date.utc(2012, 02, 01, 00)), date.local(2012, 02, 01));
  test.deepEqual(time.day.ceil(date.utc(2012, 02, 01, 00)), date.local(2012, 02, 01));
  test.end();
});

tape("day.offset(date) is an alias for day.offset(date, 1)", function(test) {
  test.deepEqual(time.day.offset(date.local(2010, 11, 31, 23, 59, 59, 999)), date.local(2011, 00, 01, 23, 59, 59, 999));
  test.end();
});
...
tape("day.offset(date, step) does not round the passed-in date", function(test) {
  test.deepEqual(time.day.offset(date.local(2010, 11, 31, 23, 59, 59, 999), +1), date.local(2011, 00, 01, 23, 59, 59, 999));
  test.deepEqual(time.day.offset(date.local(2010, 11, 31, 23, 59, 59, 456), -2), date.local(2010, 11, 29, 23, 59, 59, 456));
  test.end();
});

tape("day.offset(date, step) allows step to be negative", function(test) {
  test.deepEqual(time.day.offset(date.local(2010, 11, 31), -1), date.local(2010, 11, 30));
  test.deepEqual(time.day.offset(date.local(2011, 00, 01), -2), date.local(2010, 11, 30));
  test.deepEqual(time.day.offset(date.local(2011, 00, 01), -1), date.local(2010, 11, 31));
  test.end();
});

tape("day.offset(date, step) allows step to be positive", function(test) {
  test.deepEqual(time.day.offset(date.local(2010, 11, 31), +1), date.local(2011, 00, 01));
  test.deepEqual(time.day.offset(date.local(2010, 11, 30), +2), date.local(2011, 00, 01));
  test.deepEqual(time.day.offset(date.local(2010, 11, 30), +1), date.local(2010, 11, 31));
  test.end();
});

tape("day.offset(date, step) allows step to be zero", function(test) {
  test.deepEqual(time.day.offset(date.local(2010, 11, 31, 23, 59, 59, 999), 0), date.local(2010, 11, 31, 23, 59, 59, 999));
  test.deepEqual(time.day.offset(date.local(2010, 11, 31, 23, 59, 58, 000), 0), date.local(2010, 11, 31, 23, 59, 58, 000));
  test.end();
});
