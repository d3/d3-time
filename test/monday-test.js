...
tape("monday.floor(date) returns Mondays", function(test) {
  test.deepEqual(time.monday.floor(date.local(2011, 00, 01, 23, 59, 59)), date.local(2010, 11, 27));
  test.deepEqual(time.monday.floor(date.local(2011, 00, 02, 00, 00, 00)), date.local(2010, 11, 27));
  test.deepEqual(time.monday.floor(date.local(2011, 00, 02, 00, 00, 01)), date.local(2010, 11, 27));
  test.deepEqual(time.monday.floor(date.local(2011, 00, 02, 23, 59, 59)), date.local(2010, 11, 27));
  test.deepEqual(time.monday.floor(date.local(2011, 00, 03, 00, 00, 00)), date.local(2011, 00, 03));
  test.deepEqual(time.monday.floor(date.local(2011, 00, 03, 00, 00, 01)), date.local(2011, 00, 03));
  test.end();
});
...
tape("monday.count(start, end) observes daylight saving", function(test) {
